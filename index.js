...
.setTitle("<:partnersemote:1039339944847609926> Tommy - Moderasyon Menüsü! <:partnersemote:1039339944847609926>")
...
interaction.reply({embeds: [embed], components: [], ephemeral: true})
  ...
  if(interaction.customId == "kayıt") {
    const embed = new Discord.EmbedBuilder()
    .setTitle("<a:land_owner:1039354096605466674> Tommy - Kayıt Menüsü! <a:land_owner:1039354096605466674>")
  ...
  if(interaction.customId == "kullanıcı") {
    const embed = new Discord.EmbedBuilder()
    .setTitle("<a:land_yildizzz:1039354103282810920> Tommy - Kullanıcı Menüsü! <a:land_yildizzz:1039354103282810920>")
